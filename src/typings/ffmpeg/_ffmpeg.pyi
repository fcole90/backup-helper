...
from .nodes import filter_operator, output_operator, Stream
from .__helper_types import CLIValue

def input(filename: str, **kwargs: CLIValue) -> Stream:
...
@filter_operator()
def output(*streams_and_filename: str | Stream, **kwargs: CLIValue) -> Stream:
    """Output file URL
